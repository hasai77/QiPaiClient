export default class GameModel implements Application.GameCommonInterface.GameCommon {
    ...
    //事件列表
    public GameEventList: Array<Application.GameCommonInterface.GameCommon>
